  ...
  return (
    <section className="px-6 pb-16 pt-10 sm:pb-24 sm:pt-16">
      <div className="mx-auto max-w-3xl text-center">
        <p className="landing-eyebrow">Verified context before AI acts</p>
        <h1 className="mt-6 font-display text-4xl font-semibold leading-[1.12] tracking-tight text-land-ink sm:text-6xl">
          Your team&apos;s context,
          <br />
          <span className="text-land-forest">verified like software.</span>
        </h1>
        <p className="mx-auto mt-6 max-w-xl landing-body text-[17px]">
